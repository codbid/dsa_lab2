...
plot "kr_and_add_ex6.dat" using 1:2 title "KRHash" with linespoints ls 1 smooth bezier, \
"kr_and_add_ex6.dat" using 1:3 title "AddHash" with linespoints ls 2 smooth bezier